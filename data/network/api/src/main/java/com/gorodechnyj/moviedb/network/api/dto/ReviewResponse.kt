...
/**
 *
 * @param total Суммарное кол-во пользовательских рецензий
 * @param totalPages
 * @param totalPositiveReviews
 * @param totalNegativeReviews
 * @param totalNeutralReviews
 * @param items
 */
data class ReviewResponse(
    ...
    val totalPositiveReviews: kotlin.Int,
    val totalNegativeReviews: kotlin.Int,
    val totalNeutralReviews: kotlin.Int,
    val items: kotlin.Array<ReviewResponseItems>
)
